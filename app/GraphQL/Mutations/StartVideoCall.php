                ...
                // twilio credentials
                    ...
                    // Serialize the token as a JWT
                       $jwtToken =  $token->toJWT();
                        if(!empty($reader->device_token)){
                            $title = "Hello Join video call";
                            $body = "Hello Join video call";
                                                
                            $payloadData['author_id'] = $loggedin_user_id;
                            $payloadData['room_name'] = $data['room_name'];
                            $payloadData['room_sid'] = $data['room_sid'];
                            
                            $payloadData['user_type'] = 'reader';
                            $result = $this->sendPushNotification($title,$body, $payloadData,$reader->device_token);
                        }
